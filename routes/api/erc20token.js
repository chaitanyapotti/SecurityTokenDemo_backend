...
router.get("/tokenbalance", (req, res) => {
  ...
  contractInstance("OmiseGo", req.query.address, req.query.network)
...
//localhost:2020/web3/erc20token/totalsupply?address=0xaE9BDE445854D6ACFbC2834b495BC8D814494078&network=rinkeby
